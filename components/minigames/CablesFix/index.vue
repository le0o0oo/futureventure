      ...
      <CardContent class="h-[calc(100%-60px)]" v-auto-animate>
        ...
        <template v-if="cStep === 0">
          <h2 class="font-bold text-xl">
            C'è un componente sbagliato in questo circuito.<br />Individualo e
            sostituiscilo
          </h2>
        ...
        <MinigamesCablesFixStep1 @pass="cStep++" v-else-if="cStep === 1" />
        <MinigamesCablesFixStep2 v-else-if="cStep == 2" @close="handleClose" />
      </CardContent>
    </Card>
  </div>
</template>
